...
class GeneralGeneralSearchParam {
  final String search;
  ...
  GeneralGeneralSearchParam({required this.search, required this.employeePageSize, required this.employeePageIndex, required this.productPageSize, required this.productPageIndex, required this.orderPageSize, required this.orderPageIndex, required this.categoryPageSize, required this.categoryPageIndex});
