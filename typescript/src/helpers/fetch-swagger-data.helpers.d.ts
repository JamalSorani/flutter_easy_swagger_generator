...
export type TRouteInfo = {
  [route: string]: {
    ...
    hasPageParamInBody: boolean;
    hasPageParamInQuery: boolean;
...
declare module "openapi-v3-typescript/helpers" {
  export function toCamelCase(param: string): string;
  export function getApiNameFromRoute(
    route: string,
  ...
  export function prepareControllersRoutes({
    paths,
  ...
  export function fetchSwaggerJson({
    inputSource,
  }: {
    inputSource: string;
